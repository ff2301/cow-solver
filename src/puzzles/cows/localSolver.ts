...
export function enumerateWithLocalSolver(puzzle: CowPuzzle, limit = 200): EnumerationReport {
  ...
  return {
    ...
    engine: "Local exact search"
  };
}

export function solveWithLocalSolver(puzzle: CowPuzzle): SolveReport {
  const result = enumerateWithLocalSolver(puzzle, 1);
  return {
